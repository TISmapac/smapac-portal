            ...
            <div className="hidden md:flex items-baseline gap-1">
              {navLinks.map((l) => (
                <Link
                  key={l.href}
                  href={l.href}
                  className="relative px-3 py-2 text-sm font-semibold text-gray-700 transition-colors hover:text-amber-600 after:absolute after:left-3 after:right-3 after:-bottom-0.5 after:h-0.5 after:origin-left after:scale-x-0 after:bg-amber-500 after:transition-transform hover:after:scale-x-100"
                >
                  {l.label}
                </Link>
              ))}
